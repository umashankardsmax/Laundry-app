							...
							<div class="categories">
								<a href="product-list.html" class="category-link">
									<div class="category-icon">
                                        ...
                                        height: 46px;
                                        flex-shrink: 0;" src="{{asset('frontend/images/wm.svg')}}" alt="">
									</div>
							...
							<div class="categories">
								<a href="product.html" class="category-link">
									<div class="category-icon">
                                        ...
                                        height: 45.833px;
                                        flex-shrink: 0;" src="{{asset('frontend/images/Clothes.svg')}}" alt="">
									</div>
							...
							<div class="categories">
								<a href="product.html" class="category-link">
									<div class="category-icon">
                                        ...
                                        height: 29.486px;
                                        flex-shrink: 0;" src="{{asset('frontend/images/Iron.svg')}}" alt="">
									</div>
							...
							<div class="categories">
								<a href="product.html" class="category-link">
									<div class="category-icon">
                                        ...
                                        height: 48.46px;
                                        flex-shrink: 0;" src="{{asset('frontend/images/Carpet.svg')}}" alt="">
									</div>
							...
							<div class="categories">
								<a href="product.html" class="category-link">
									<div class="category-icon">
                                        ...
                                        height: 41.834px;
                                        flex-shrink: 0;" src="{{asset('frontend/images/bulk.svg')}}" alt="">
									</div>
							...
							<div class="categories">
								<a href="product.html" class="category-link">
									<div class="category-icon">
                                        ...
                                        height: 37.297px;
                                        flex-shrink: 0;" src="{{asset('frontend/images/Bed.svg')}}" alt="">
									</div>
						...
						<div class="shop-card row">
                            ...
                            <div style="width:50%; align-items:center;" class=" col-6">
								<a href="product-detail.html">
                                    ...
                                    height: 137px;
                                    flex-shrink: 0;" src="{{asset('frontend/images/wash.png')}}" alt="image">
								</a>
							</div>
						</div>
					</div>
						...
						<div style="padding: 20px 0px; background: #FFCA42;" class="shop-card row">
                            ...
                            <div class="col-3 process">
                                <div class="category-icon">
                                    <img style="width: 34.233px;
                                    height: 40px;
                                    flex-shrink: 0;" src="{{asset('frontend/images/order.png')}}" alt="">
                                </div>
                            ...
                            <div class="col-3 process">
                                <div class="category-icon">
                                    <img style="width: 34.233px;
                                    height: 40px;
                                    flex-shrink: 0;" src="{{asset('frontend/images/collect.png')}}" alt="">
                                </div>
                            ...
                            <div class="col-3 process">
                                <div class="category-icon">
                                    <img style="width: 34.233px;
                                    height: 40px;
                                    flex-shrink: 0;" src="{{asset('frontend/images/clean.png')}}" alt="">
                                </div>
                            ...
                            <div class="col-3 process">
                                <div class="category-icon">
                                    <img style="width: 34.233px;
                                    height: 40px;
                                    flex-shrink: 0;" src="{{asset('frontend/images/delivery.png')}}" alt="">
                                </div>
